...
В прямой задаче нам дан весь ветор p. <br/>
...
а y₀, v₀, θ₀ необходимо восстановить из конечного положения пули. <br/>
...
по набору векторных параметров p₁,...,pₖ. Так как параметры l, ρ, σ имеют одинаковые и известные значения, pₖ-ые различаются только на неизвестные yₖ, vₖ, θₖ. Тогда предыдущую формулу можно конкретизировать как <br/>
